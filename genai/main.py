...
def api_debug_rag():
    ...
    # Path settings
    try:
        from knowledge_base.rag import CHROMA_DB_DIR, USE_LOCAL_EMBEDDINGS, ON_RENDER
        debug_info["CONFIG"] = {
    ...
    # Collection check
    try:
        from knowledge_base.rag import get_collection
        coll = get_collection()
    ...
    try:
        from knowledge_base.rag import embed_query
    ...
    # Retrieval check
    try:
        from knowledge_base.rag import retrieve_relevant_chunks
